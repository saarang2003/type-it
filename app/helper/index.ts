...
export function getRandomWords(
  ...
  const generated = generate({ exactly: quantity, maxLength: 6 });
  const wordsArr: string[] = Array.isArray(generated) ? generated : [generated];
...
export function ISOToDate(s: string) {
  const b: number[] = s.split(/\D+/).map(Number);
